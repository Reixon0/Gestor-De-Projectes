...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4B1g65PoyV', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZsIwmxJeYK', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('430vcNsOcz', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('n6tHUIqR-8', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0e50561adc0181c22ccdcb39bb21e76833e5a40a')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Vallbona/webBundle/Resources/views'), '!Vallbonaweb');
        $instance->addPath(($this->targetDirs[3].'/src/GestorProjectes/BackendBundle/Resources/views'), 'GestorProjectesBackend');
        $instance->addPath(($this->targetDirs[3].'/src/GestorProjectes/BackendBundle/Resources/views'), '!GestorProjectesBackend');
        $instance->addPath(($this->targetDirs[3].'/src/GestorProjectes/FrontendBundle/Resources/views'), 'GestorProjectesFrontend');
        $instance->addPath(($this->targetDirs[3].'/src/GestorProjectes/FrontendBundle/Resources/views'), '!GestorProjectesFrontend');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0e50561adc0181c22ccdcb39bb21e76833e5a40a');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'GestorProjectesBackendBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GestorProjectes/BackendBundle'),
                    'namespace' => 'GestorProjectes\\BackendBundle',
                ),
                'GestorProjectesFrontendBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GestorProjectes/FrontendBundle'),
                    'namespace' => 'GestorProjectes\\FrontendBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GestorProjectesBackendBundle' => 'GestorProjectes\\BackendBundle\\GestorProjectesBackendBundle',
                'GestorProjectesFrontendBundle' => 'GestorProjectes\\FrontendBundle\\GestorProjectesFrontendBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'gestor_de_projectes',
            'database_user' => 'root',
            ...
            'secret' => '0e50561adc0181c22ccdcb39bb21e76833e5a40a',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '0e50561adc0181c22ccdcb39bb21e76833e5a40a',
